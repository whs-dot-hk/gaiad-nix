with inputs.nixpkgs; let
  ...
  gaiad_26_0_0 = stdenv.mkDerivation rec {
    pname = "gaiad";
    version = "26.0.0";
    src = fetchurl {
      url = "https://github.com/cosmos/gaia/releases/download/v${version}/gaiad-v${version}-linux-amd64";
      sha256 = "sha256-+G/VpUYjkR9ZpQcG4C3dCeXBMPbiNgsjO0Mp2tRZQrA=";
    };
    dontUnpack = true;
    dontBuild = true;
    dontConfigure = true;
  ...
  gaiad_27_0_0 = stdenv.mkDerivation rec {
    pname = "gaiad";
    version = "27.0.0";
    src = fetchurl {
      url = "https://github.com/cosmos/gaia/releases/download/v${version}/gaiad-v${version}-linux-amd64";
      sha256 = "sha256-PTkfHhSV2e8O1k4gSjeiSYLFAha6/0MFK6PbYJYK8ek=";
    };
    dontUnpack = true;
    dontBuild = true;
    dontConfigure = true;
  ...
  gaiad_27_1_0 = stdenv.mkDerivation rec {
    pname = "gaiad";
    version = "27.1.0";
    src = fetchurl {
      url = "https://github.com/cosmos/gaia/releases/download/v${version}/gaiad-v${version}-linux-amd64";
      sha256 = "sha256-lYxamXOFkokd6Iai+9hurORWihgE6JNZoyiJwBr8F38=";
    };
    dontUnpack = true;
    dontBuild = true;
    dontConfigure = true;
  ...
  gaiad_27_2_0 = stdenv.mkDerivation rec {
    pname = "gaiad";
    version = "27.2.0";
    src = fetchurl {
      url = "https://github.com/cosmos/gaia/releases/download/v${version}/gaiad-v${version}-linux-amd64";
      sha256 = "sha256-jAhvWeySThu9MIYkrFnQ3ntaY0VNYoRCJJETsF7Gnz0=";
    };
    dontUnpack = true;
    dontBuild = true;
    dontConfigure = true;
  ...
  gaiad_27_3_0 = stdenv.mkDerivation rec {
    pname = "gaiad";
    version = "27.3.0";
    src = fetchurl {
      url = "https://github.com/cosmos/gaia/releases/download/v${version}/gaiad-v${version}-linux-amd64";
      sha256 = "sha256-rb9YVVsYYo/J9xk/llYolDok3PEC7KhttL0YsHGvWLM=";
    };
    dontUnpack = true;
    dontBuild = true;
    dontConfigure = true;
  ...
  gaiad_27_4_0 = stdenv.mkDerivation rec {
    pname = "gaiad";
    version = "27.4.0";
    src = fetchurl {
      url = "https://github.com/cosmos/gaia/releases/download/v${version}/gaiad-v${version}-linux-amd64";
      sha256 = "sha256-WGZtmq3mLHwb4GdatdYB0RG/u7IUHiLL61dE078HVVI=";
    };
    dontUnpack = true;
    dontBuild = true;
    dontConfigure = true;
  ...
  gaiad_27_5_0 = stdenv.mkDerivation rec {
    pname = "gaiad";
    version = "27.5.0";
    src = fetchurl {
      url = "https://github.com/cosmos/gaia/releases/download/v${version}/gaiad-v${version}-linux-amd64";
      sha256 = "sha256-y+Ce3get6yLWq70Oq4ImzSmsKKCVBcENqpvlOmEqJcs=";
    };
    dontUnpack = true;
    dontBuild = true;
    dontConfigure = true;
...
in {
  ...
  inherit gaiad_26_0_0;
  inherit gaiad_27_0_0;
  inherit gaiad_27_1_0;
  inherit gaiad_27_2_0;
  inherit gaiad_27_3_0;
  inherit gaiad_27_4_0;
  inherit gaiad_27_5_0;
}
